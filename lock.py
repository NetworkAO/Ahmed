...
# some of the code work in python 2 so we need to include both 
try:
	# python 2
...
class Fullscreen_Window:
	...
	def __init__(self):
		self.tk = tk.Tk()
		self.tk.title("Multiple factor authentication smart Door Lock system")
		...
		t.daemon = True
		t.start()
		#message on the screen  to promt the user to scan card 
	def show_idle(self):
	...
	def listen_rfid(self):
		global pin
		global accessLogId
		#the key of the card reader 
		keys = "X^1234567890XXXXqwertzuiopXXXXasdfghjklXXXXXyxcvbnmXXXXXXXXXXXXXXXXXXXXXXX"
		dev = InputDevice('/dev/input/event1') # the location of the input of the card reader 
		rfid_presented = ""
